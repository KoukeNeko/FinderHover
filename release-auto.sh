...
echo ""
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${YELLOW}📝 IMPORTANT: Edit appcast.xml release notes${NC}"
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "File: ${BLUE}appcast.xml${NC}"
echo -e "Search for: ${RED}TODO: Edit release notes in appcast.xml${NC}"
echo ""
echo "Replace the placeholder with detailed release notes:"
echo -e "${GREEN}<description><![CDATA[${NC}"
echo -e "${GREEN}    <h2>What's New in $VERSION</h2>${NC}"
echo -e "${GREEN}    <ul>${NC}"
echo -e "${GREEN}        <li><strong>Fixed:</strong> Description...</li>${NC}"
echo -e "${GREEN}        <li><strong>Added:</strong> Description...</li>${NC}"
echo -e "${GREEN}        <li><strong>Improved:</strong> Description...</li>${NC}"
echo -e "${GREEN}    </ul>${NC}"
echo -e "${GREEN}]]${NC}${GREEN}>></description>${NC}"
echo ""
echo -e "${YELLOW}Then commit and push:${NC}"
echo -e "  ${BLUE}git add appcast.xml${NC}"
echo -e "  ${BLUE}git commit -m \"docs: update v$VERSION release notes in appcast\"${NC}"
...
echo "2. Test update from previous version"
echo ""
