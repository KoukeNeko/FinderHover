...
- 🚀 **Automatic Updates**: Integrated Sparkle framework for seamless automatic updates
- 🔐 **Enhanced Security**: EdDSA cryptographic signature verification for all updates
- ⚙️ **User Control**: Configurable automatic update checking in Settings
- 📜 **Automation**: Release scripts for streamlined publishing process

### Previous Releases

- **v1.1.4**: macOS 15.x corner radius fix, GitHub contributors display
- **v1.1.3**: Windows-style tooltip option, dual UI modes
- **v1.1.2**: Video and audio metadata support
- **v1.1.1**: Multi-language support (English, 繁體中文, 日本語)
- **v1.1.0**: EXIF photo information, customizable display order
- **v1.0.0**: Initial release with hover preview, file metadata, settings
