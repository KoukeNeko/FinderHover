        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(spacing: 0) {
                        DisplayToggleRow(title: "settings.display.exif.show".localized, icon: "camera", isOn: $settings.showEXIF)
                        Divider().padding(.leading, 60)
                        ...
                        DisplayToggleRow(title: "settings.display.exif.dateTaken".localized, icon: "calendar.badge.clock", isOn: $settings.showEXIFDateTaken)
                            ...
                            .opacity(settings.showEXIF ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.exif.dimensions".localized, icon: "arrow.up.left.and.arrow.down.right", isOn: $settings.showEXIFDimensions)
                            .disabled(!settings.showEXIF)
                            .opacity(settings.showEXIF ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.exif.gps".localized, icon: "location", isOn: $settings.showEXIFGPS)
                            .disabled(!settings.showEXIF)
                            .opacity(settings.showEXIF ? 1.0 : 0.5)
                    }
                    .background(Color(NSColor.controlBackgroundColor))
                    ...
                    VStack(spacing: 0) {
                        DisplayToggleRow(title: "settings.display.video.show".localized, icon: "video", isOn: $settings.showVideo)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.video.duration".localized, icon: "clock", isOn: $settings.showVideoDuration)
                            .disabled(!settings.showVideo)
                            .opacity(settings.showVideo ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.video.resolution".localized, icon: "arrow.up.left.and.arrow.down.right", isOn: $settings.showVideoResolution)
                            .disabled(!settings.showVideo)
                            .opacity(settings.showVideo ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.video.codec".localized, icon: "film", isOn: $settings.showVideoCodec)
                            .disabled(!settings.showVideo)
                            .opacity(settings.showVideo ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.video.framerate".localized, icon: "speedometer", isOn: $settings.showVideoFrameRate)
                            .disabled(!settings.showVideo)
                            .opacity(settings.showVideo ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.video.bitrate".localized, icon: "speedometer", isOn: $settings.showVideoBitrate)
                            .disabled(!settings.showVideo)
                            .opacity(settings.showVideo ? 1.0 : 0.5)
                    }
                    .background(Color(NSColor.controlBackgroundColor))
                    ...
                    VStack(spacing: 0) {
                        DisplayToggleRow(title: "settings.display.audio.show".localized, icon: "music.note", isOn: $settings.showAudio)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.audio.title".localized, icon: "textformat", isOn: $settings.showAudioTitle)
                            .disabled(!settings.showAudio)
                            .opacity(settings.showAudio ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.audio.artist".localized, icon: "person", isOn: $settings.showAudioArtist)
                            .disabled(!settings.showAudio)
                            .opacity(settings.showAudio ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.audio.album".localized, icon: "square.stack", isOn: $settings.showAudioAlbum)
                            .disabled(!settings.showAudio)
                            .opacity(settings.showAudio ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.audio.genre".localized, icon: "music.note.list", isOn: $settings.showAudioGenre)
                            .disabled(!settings.showAudio)
                            .opacity(settings.showAudio ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.audio.year".localized, icon: "calendar", isOn: $settings.showAudioYear)
                            .disabled(!settings.showAudio)
                            .opacity(settings.showAudio ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.audio.duration".localized, icon: "clock", isOn: $settings.showAudioDuration)
                            .disabled(!settings.showAudio)
                            .opacity(settings.showAudio ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.audio.bitrate".localized, icon: "speedometer", isOn: $settings.showAudioBitrate)
                            .disabled(!settings.showAudio)
                            .opacity(settings.showAudio ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.audio.samplerate".localized, icon: "waveform", isOn: $settings.showAudioSampleRate)
                            .disabled(!settings.showAudio)
                            .opacity(settings.showAudio ? 1.0 : 0.5)
                    }
                    .background(Color(NSColor.controlBackgroundColor))
