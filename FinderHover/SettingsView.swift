        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(spacing: 0) {
                        DisplayToggleRow(title: "settings.display.video.show".localized, icon: "video.fill", isOn: $settings.showVideo)
                        Divider().padding(.leading, 60)
                        ...
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.video.resolution".localized, icon: "rectangle.resize", isOn: $settings.showVideoResolution)
                            .disabled(!settings.showVideo)
                            .opacity(settings.showVideo ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.video.codec".localized, icon: "film", isOn: $settings.showVideoCodec)
                            ...
                            .opacity(settings.showVideo ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.video.framerate".localized, icon: "gauge", isOn: $settings.showVideoFrameRate)
                            .disabled(!settings.showVideo)
                            .opacity(settings.showVideo ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
                    ...
                    VStack(spacing: 0) {
                        ...
                        Divider().padding(.leading, 60)
                        DisplayToggleRow(title: "settings.display.audio.artist".localized, icon: "person.fill", isOn: $settings.showAudioArtist)
                            .disabled(!settings.showAudio)
                            .opacity(settings.showAudio ? 1.0 : 0.5)
                        Divider().padding(.leading, 60)
